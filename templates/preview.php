      ...
      <tbody><tr class="main">
        <td class="main" style="padding:3px 5px 5px 5px;" width="145">
          <table>
            <tbody><tr>
              <td>
                  <img class="cart_icon" src="<?php echo plugins_url( 'assets/images/bttn_cart_white.png' , dirname(__FILE__) );  ?>" style="margin-left: 5px; margin-right:10px; margin-top:8px;">
              </td>
              <td>
